...
const Sidebar = () => {
    // Icons using simple SVG components for zero dependency
    const HomeIcon = () => (
    ...
    const ActivityIcon = () => (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="nav-icon"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg>
    );
    ...
    return (
        <aside className="sidebar">
            <div className="logo-area">
                ...
                <span className="logo-text">MediTriage</span>
            </div>
            ...
            <nav className="nav-menu">
                ...
                <a href="#" className="nav-item">
                    <UsersIcon /> <span>Patients</span>
                </a>
                <a href="#" className="nav-item">
                    <ActivityIcon /> <span>Analytics</span>
                </a>
                <a href="#" className="nav-item">
            ...
            <div className="user-area">
                ...
                <div className="user-info">
                    <span className="user-name">Dr. Ray</span>
                    <span className="user-role">Chief Resident</span>
                </div>
            </div>
        </aside>
    );
